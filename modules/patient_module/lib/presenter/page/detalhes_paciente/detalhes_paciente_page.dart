...
class _DetalhesPacientePageState extends State<DetalhesPacientePage> {
  ...
  DetalhesPacienteEntity? detalhesPacienteEntity;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider<DetalhesPacienteBloc>(
        ...
        child: SafeArea(
          child: BlocConsumer<DetalhesPacienteBloc, DetalhesPacienteState>(
            listener: (context, state) {
              if(state is DetalhesPacienteSuccessState){
                setState(() {
                  detalhesPacienteEntity = state.detalhesPacienteEntity;
                });
              }
            },
                  ...
                  children: [
                    ...
                    if (state.detalhesPacienteEntity.alergyList.isEmpty)
                      const Padding(
                          ...
                          child: Center(
                              child: Text(
                                "Paciente ainda não cadastrou nenhuma alergia",
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                    color: Colors.black,
                                    fontSize: 18,
      ...
      bottomNavigationBar: detalhesPacienteEntity == null ? null : Container(
          decoration: const BoxDecoration(
              color: Colors.white,
              boxShadow: [
                BoxShadow(
...
String translateDate(String date) {
  ...
  var month = date.split(",")[1].trim().split(" ").first;
